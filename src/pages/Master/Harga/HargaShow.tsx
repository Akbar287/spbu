...
import {
    ...
    AlertCircle, Loader2, Sparkles, Package, TrendingUp, TrendingDown, Clock, Star
} from 'lucide-react';
...
export default function HargaShow() {
            ...
            <div className="min-h-screen relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center min-h-screen">
                    ...
                    >
                        ...
                        <p className="text-slate-600 dark:text-slate-400 font-medium">Memuat detail Harga...</p>
                    </motion.div>
                </div>
            </div>
        );
            ...
            <div className="min-h-screen relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center min-h-screen">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Harga Tidak Ditemukan</h2>
                        <p className="text-slate-600 dark:text-slate-400">Data Harga dengan ID {hargaId} tidak ditemukan.</p>
                        <motion.button
    ...
    const detailItems = [
        { label: 'ID Harga', value: hargaData.hargaId.toString(), icon: Hash, color: 'amber' },
        ...
        { label: 'Diperbarui', value: formatDateTime(hargaData.updatedAt), icon: Clock, color: 'gray' },
    ];
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
                ...
                {/* Status Badge */}
                <motion.div
                    className={`mb-6 p-4 backdrop-blur-sm rounded-2xl border flex items-center gap-3 ${hargaData.isDefault
                        ? 'bg-amber-50/80 dark:bg-amber-900/20 border-amber-200/50 dark:border-amber-500/30'
                        : 'bg-slate-50/80 dark:bg-slate-900/20 border-slate-200/50 dark:border-slate-500/30'
                        }`}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    {hargaData.isDefault ? (
                        <>
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-amber-700 dark:text-amber-300">Harga Default</h3>
                                <p className="text-sm text-amber-600 dark:text-amber-400">Harga ini sedang aktif sebagai harga utama</p>
                            </div>
                        </>
                    ) : (
                        <>
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Riwayat Harga</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400">Harga ini adalah harga sebelumnya (non-aktif)</p>
                            </div>
                        </>
                    )}
                </motion.div>
