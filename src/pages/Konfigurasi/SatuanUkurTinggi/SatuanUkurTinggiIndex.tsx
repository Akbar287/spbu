...
import {
    ...
    ArrowLeft, Grid3X3, List, Loader2, AlertCircle, Scale, Tag,
    Eye
} from 'lucide-react';
...
export default function SatuanUkurTinggiIndex() {
    const navigate = useNavigate();
    const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid');
    const [currentPage, setCurrentPage] = useState(1);
    const [pageSize, setPageSize] = useState(10);
    const [deleteTarget, setDeleteTarget] = useState<SatuanUkurTinggi | null>(null);
    ...
    const { data: totalCountResponse } = useReadContract({
        ...
        abi: DIAMOND_ABI,
        functionName: 'getCountSatuanUkurTinggi',
        args: [],
    });
    ...
    const items = useMemo(() => {
        ...
        return (rawList as BlockchainSatuanUkurTinggi[])
            ...
            .map(item => ({
                id: Number(item.satuanUkurTinggiId),
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            >
                                Kelola satuan pengukuran tinggi (cm, m, dll)
                            </motion.p>
                        </div>
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => navigate('/konfigurasi/satuan-ukur-tinggi/create')}
                                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white font-semibold rounded-2xl shadow-lg shadow-orange-500/30 transition-all"
                ...
                {!isLoading && !error && items.length === 0 && (
                    ...
                    >
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Tambahkan satuan ukur tinggi pertama Anda</p>
                        <motion.button
                            onClick={() => navigate('/konfigurasi/satuan-ukur-tinggi/create')}
                            className="flex items-center gap-2 px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-xl"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                        ...
                        {items.map((item, index) => (
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    style={{
                                        background: 'linear-gradient(45deg, rgba(249,115,22,0.3), rgba(239,68,68,0.3), rgba(249,115,22,0.3))',
                                ...
                                <div className="relative z-10">
                                        ...
                                        <motion.div
                                            ...
                                            style={{
                                                background: `linear-gradient(135deg, 
                                                    hsl(${20 + index * 10}, 80%, 60%) 0%, 
                                                    hsl(${40 + index * 10}, 70%, 55%) 100%)`,
                                            }}
                                        />
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="pt-4 border-t border-slate-200/50 dark:border-slate-700/50 flex items-center gap-2">
                                            <motion.button
                                                onClick={() => navigate(`/konfigurasi/satuan-ukur-tinggi/${item.id}`)}
                                                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-300 font-medium rounded-xl hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors"
                                            ...
                                            <motion.button
                                                ...
                                                onClick={() => navigate(`/konfigurasi/satuan-ukur-tinggi/${item.id}/edit`)}
                        ...
                        >
                            <div className="p-6 text-center">
                                ...
                                <p className="text-slate-600 dark:text-slate-400 mb-6">
                                    Apakah Anda yakin ingin menghapus <strong className="text-slate-800 dark:text-white">{deleteTarget.namaSatuan}</strong>? Data yang dihapus tidak dapat dikembalikan.
                                </p>
