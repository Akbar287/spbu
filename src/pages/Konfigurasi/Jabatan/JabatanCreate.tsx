...
import {
    Briefcase, ArrowLeft, Save, BarChart2, FileText,
    AlertCircle, CheckCircle2, Loader2, Sparkles, Building2
} from 'lucide-react';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 mt-1">
                                Kelola struktur jabatan dan posisi dalam organisasi
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="relative z-10 p-6 md:p-8 space-y-6">
                        ...
                        >
                            ...
                            {isLoadingLevel && !levelList.length ? (
                                <div className="flex items-center gap-2 text-slate-500 text-sm p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                                ...
                                <select
                                    {...register('levelId')}
                                    className={`${getInputClass('levelId')} text-slate-700 dark:text-slate-200 cursor-pointer`}
                                >
                        ...
                        >
                            ...
                            <input
                                ...
                                placeholder="Contoh: Kepala Divisi IT, Staff Admin"
                        ...
                        >
                            ...
                            <textarea
                                {...register('keterangan')}
                                rows={4}
                                placeholder="Deskripsi jabatan dan tanggung jawab utama..."
